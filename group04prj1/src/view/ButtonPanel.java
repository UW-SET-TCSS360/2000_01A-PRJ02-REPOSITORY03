...
public class ButtonPanel extends JPanel {
	...
	public ButtonPanel(JFrame theFrame) {
		...
		//Needs a graph to interact with
		
		JButton weatherCenterButton = new JButton("WxCen");
		weatherCenterButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		weatherCenterButton.setBounds(10, 11, 89, 23);
		this.add(weatherCenterButton);
		myButtons.add(weatherCenterButton);
